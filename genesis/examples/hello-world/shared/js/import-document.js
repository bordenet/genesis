 ...
 * Handles importing existing Hello World documents from Word/Google Docs via paste
 */
...
export function showImportModal() {
  ...
  saveBtn.addEventListener('click', async () => {
    ...
    try {
      ...
      const title = titleMatch ? titleMatch[1].replace(/^Document:\s*/i, '').trim() : `Imported ${DOC_TYPE_SHORT}`;
